    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Tickets AssignedUser</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.tickets_assigned_user &&
                      Array.isArray(users.tickets_assigned_user) &&
                      users.tickets_assigned_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!users?.tickets_assigned_user?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
