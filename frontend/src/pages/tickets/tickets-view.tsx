      ...
      <SectionMain>
        ...
        >
          <BaseButton
            color='info'
            label='Edit'
            href={`/tickets/tickets-edit/?id=${id}`}
          />
        </SectionTitleLineWithButton>
        <CardBox>
          <div className={'mb-4'}>
          ...
          <div className={'mb-4'}>
            ...
            {tickets.description ? (
              <p dangerouslySetInnerHTML={{ __html: tickets.description }} />
            ) : (
              <p>No data</p>
            )}
          </div>
          ...
          <div className={'mb-4'}>
            ...
            <p>{tickets?.assigned_user?.firstName ?? 'No data'}</p>
          </div>
            ...
            {tickets.created_date ? (
              <DatePicker
                ...
                selected={
                  tickets.created_date
                    ? new Date(
                        dayjs(tickets.created_date).format('YYYY-MM-DD hh:mm'),
                      )
                    : null
                }
                disabled
            ...
            {tickets.due_date ? (
              <DatePicker
                ...
                selected={
                  tickets.due_date
                    ? new Date(
                        dayjs(tickets.due_date).format('YYYY-MM-DD hh:mm'),
                      )
                    : null
                }
                disabled
